      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <textarea name="cart_reminder_textarea" rows="5" id="input-code" class="form-control"><?php echo $cart_reminder_textarea; ?></textarea>
              <?php if ($error_code) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="cart_reminder_status" id="input-status" class="form-control">
                <?php if ($cart_reminder_status) { ?>
